...
const PokemonDetailsStatCard: FC<PokemonDetailsPokemon> = ({ pokemon }) => {
  return (
    <div className="flex flex-col shadow-lg items-center justify-center p-4 rounded-2xl  bg-bgSecondary">
      <h2 className="text-2xl text-white">Stats</h2>
      <div className="flex flex-col w-full items-center justify-center gap-2 mt-4">
        <PokemonDetailsStatBarHorizontal
          statName="HP"
        ...
        <PokemonDetailsStatBarHorizontal
          ...
          statValue={pokemon.specialAttack}
          primaryType={pokemon.types[0]}
        />
        <PokemonDetailsStatBarHorizontal
          statName="Special Defense"
          statValue={pokemon.specialDefense}
          primaryType={pokemon.types[0]}
        />
        <PokemonDetailsStatBarHorizontal
          statName="Speed"
